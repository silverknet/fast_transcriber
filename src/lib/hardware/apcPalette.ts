/**
 * The APC Key 25 mk2's fixed 128-colour pad palette, indexed by velocity — from
 * Akai's official communication protocol (v1.1). `sendPadRaw(pad, velocity)`
 * lights a pad in `APC_PALETTE[velocity]`. Used by the colour-lab debug page to
 * preview real hardware colours and pick section/stem palettes.
 */
export const APC_PALETTE: string[] = [
