...
export const SONGMAP_FORMAT_VERSION = 7 as const
...
export const SONGMAP_DRAFTS_FORMAT_VERSION = 6 as const
...
export const SONGMAP_VERSION_CHANGELOG: string[] = [
  ...
  'v7: canonical Live source intents and explicit source-to-mixer-to-rig-lane bindings. Legacy producers migrate as excluded until reviewed.',
]
