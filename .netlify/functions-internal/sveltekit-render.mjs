	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/projects/_id_/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/sessions/ensure/_server.ts.js'))
			},
			{
				id: "/api/sessions/[id]",
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/sessions/_id_/_server.ts.js'))
			},
			{
				id: "/download",
				pattern: /^\/download\/?$/,
