//#region src/lib/audio/trimAudio.ts
...
async function trimAudioFileToWav(inputFile, startSec, endSec) {
	...
	try {
		...
		return {
			file: new File([blob], `${base}_selected.wav`, { type: "audio/wav" }),
			durationSec: frames / src.sampleRate
		};
	} finally {
...
//#endregion
export { trimAudioFileToWav as n, audioBufferToWavBlob as t };
